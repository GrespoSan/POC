...
st.caption(
    "Ricerca titoli con prezzo vicino al Point Of Control del Macro Swing"
)
...
if st.button(
    ...
    def update_progress(value):
        ...
        status.write(
            ...
            f"Analisi completata: {int(value*100)}%"
